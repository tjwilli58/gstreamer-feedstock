...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gstreamer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gstreamer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gst-plugins-base gst-plugins-good gstreamer
# for installing globally
pixi global install gst-plugins-base gst-plugins-good gstreamer
```
...
It is possible to list all of the versions of `gst-plugins-base` available on your platform:
...
```
pixi search gst-plugins-base --channel conda-forge
```
